...
// LOOK AT LINE 67 FOR BACK TO INDEX and 110
include 'parsedown.php'; // Used to parse markdown
echo '<!DOCTYPE html>';
echo '<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">';
echo '<head>';
echo '<title>mozzarella.catalog</title>'; // Site title
...
if (empty($base)) // If no subdirectory: frontpage 
...
else //If not frontpage
  {
    ...
    // Back to index     
    echo '<div id="index"><a href="http://mozzarella.website/">←Index</a></div>'; //Link back to the index-page
    echo '<h1>' . $title . '</h1>';
    // Output index text    
